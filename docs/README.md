...
| [examples/](examples/jsp-envelope.example.json)      | What does a real Normalized AST envelope look like end-to-end? Includes a full JSP envelope sample plus two Mode-B adapter examples ([openapi-sdk-adapter/](examples/openapi-sdk-adapter/), [svelte-adapter/](examples/svelte-adapter/)). |

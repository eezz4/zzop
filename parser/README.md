...
`NormalizedEnvelope` JSON document (validated by `zpz_core::validate_envelope`, consumed by
`zpz_engine::analyze_envelope`) plugs in without touching this workspace at all. `docs/examples/jsp-envelope.example.json`

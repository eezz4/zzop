...
//! iteration" cannot be honored for the lambda's body, so this module stays silent there. (Which
//! forms every OTHER language treats as lazy is not restated here —

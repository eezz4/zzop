...
//
// SOURCE OF TRUTH: examples/adapter-kit/lib/keys.js (the canonical implementation) and
// docs/adapters/key-normalization.fixture.json (the parity fixture, generated from the real Rust
// functions). This file is copied from the adapter-kit at `zzop` CLI authoring time because the kit
// itself is NOT published to npm (see docs/adapters/README.md) — this scaffold has to be
// self-contained. If you edit the normalization logic below, replay
// docs/adapters/key-normalization.fixture.json's rows against your version in your own adapter's
// tests (mirror examples/adapter-kit/test/keys.test.js's pattern) before trusting it — cross-layer

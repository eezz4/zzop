// Copies the repo's DSL rule packs (<repo root>/rules/dsl/) into packages/native/rules/, so they ship
...
// `zzop_core::pack_loader::load_dsl_packs`'s own two-shape scan (crates/core/src/pack_loader.rs) so the

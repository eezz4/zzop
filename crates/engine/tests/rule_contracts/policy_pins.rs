//! Contract 12: cross-pack policy-vocabulary pin — reliability/sync-fs-in-handler and
//! db/client-per-request must share one "handler-context" evidence definition.

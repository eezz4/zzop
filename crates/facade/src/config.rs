...
/// that replacement itself is unchanged/intentional (the override path `docs/modules/facade.md`'s
...
///    override path (see `docs/modules/facade.md`'s "Defaults" section) — `zzop-config` puts
